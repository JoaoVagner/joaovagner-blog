...
<li>
<?php 
	$ban1 = get_option('nomad_banner1'); 
	$url1 = get_option('nomad_url1'); 
	$lab1 = get_option('nomad_lab1'); 
	$alt1 = get_option('nomad_alt1');
?>
...
<li>
<?php 
	$ban2 = get_option('nomad_banner2'); 
	$url2 = get_option('nomad_url2'); 
	$lab2 = get_option('nomad_lab2'); 	
	$alt2 = get_option('nomad_alt2');
?>
...
<li>
<?php 
	$ban3 = get_option('nomad_banner3'); 
	$url3 = get_option('nomad_url3'); 
	$lab3 = get_option('nomad_lab3'); 
	$alt3 = get_option('nomad_alt3');	
?>
...
<li>
<?php 
	$ban4 = get_option('nomad_banner4'); 
	$url4 = get_option('nomad_url4');
	$lab4 = get_option('nomad_lab4'); 
	$alt4 = get_option('nomad_alt4');	
?>
